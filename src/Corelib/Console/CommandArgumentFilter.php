...
class CommandArgumentFilter
{
     ...
     * @var \Corelib\Console\CommandLineDefinition
     */
     ...
     * @author Patrick Forget <patforg at geekpad.ca>
     * 
     * @param \Corelib\Console\CommandLineDefinition $definitions contains list of allowed parameters
     * @param array $args list of arguments to filter. 
     */
    public function __construct(\Corelib\Console\CommandLineArgumentDefinition $definitions, $args) {
        if (is_array($args)) {
            $this->arguments = $args;
        } //if
